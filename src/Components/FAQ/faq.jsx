...
function FAQ() {
    ...
    return (
        ...
        <button className="mt-6 w-[124px] h-[48px] btn2 text-[12px] font-black lg:flex items-center justify-center hidden" style={{border:"none",outline:"none",borderRadius:"50px"}}>CONTACT US</button>
            ...
            <div className='mt-28'>
            <div className='sm:w-[400px] w-[300px] rounded-md faqDiv1 faqDiv'>
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a className="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <GrFormSubtract/>
                </a>
                    </div>
                )}
                ...
                <div className="card card-body sm:w-[380px] pt-0 pb-3 pr-3 text-[12px] bg-black" style={{background:"transparent"}}>
                To sell your NFTs on a marketplace, you{"’"}ll need to locate them in your collection, click on them and find the “sell” button.
                </div>
                </div>
                </div>

                <div className='sm:w-[400px] w-[300px] rounded-md mt-3 faqDiv faqDiv2 '>
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a className="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <GrFormSubtract/>
                </a>
                    </div>
                )}
                ...
                <div className='sm:w-[400px] w-[300px]faqDiv rounded-md mt-3 faqDiv faqDiv3'>
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a className="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <GrFormSubtract/>
                </a>
                    </div>
                )}
                ...
                <div className='sm:w-[400px] w-[300px] faqDiv rounded-md mt-3 faqDiv4'>
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a className="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <GrFormSubtract/>
                </a>
                    </div>
                )}
                ...
                <div className='sm:w-[400px] w-[300px] faqDiv rounded-md mt-3 faqDiv5'>
            <div className='flex justify-between items-center px-3 py-3'>
               ...
               <a className="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <GrFormSubtract/>
                </a>
                    </div>
                )}
