...
function Roadmap() {
    return (
        <div className="faqs sm:pl-12 pl-0" id="roadmap">
            <div className="flex flex-col items-center text-white relative mt-32">
                ...
                <div className="w-full lg:block flex flex-col items-center justify-center sm:pl-2 pl-0 py-10 ">
                    <div className="flex md:items-center items-start lg:ml-[5%] ml-[0%]">
                        <div className="sm:w-[80px] w-[50px] sm:h-[80px] h-[50px] border-2 border-[#D8FB50] rounded-full flex flex-col items-center justify-center sm:text-[18px] text-[12px] sm:font-black font-normal">
                            <h1>Q1,</h1>
                            <h1>2020</h1>
                        </div>
                        <div className="sm:w-[400px] w-[250px] rounded-lg py-4 px-3 ml-2 bg-[#292929]">
                    ...
                    <div className="flex items-center lg:ml-[8%] ml-[0%]">
                        <img src={Arrow} className="mt-[-5%] w-[80px] h-[120px] lg:flex hidden" alt=""/>
                    ...
                    <div className="flex items-center lg:ml-[17%] ml-[0%]">
                        <img src={Arrow} className="mt-[-5%] w-[80px] h-[120px] lg:flex hidden" alt=""/>
                        <div className="flex md:items-center items-start mt-10">
                            <div className="sm:w-[80px] w-[50px] sm:h-[80px] h-[50px] border-2 border-[#D8FB50] rounded-full flex flex-col items-center justify-center sm:text-[18px] text-[12px] sm:font-black font-normal">
                                <h1>Q1,</h1>
                    ...
                    <div className="flex items-center lg:ml-[25%] ml-[0%]">
                        <img src={Arrow} className="mt-[-5%] w-[80px] h-[120px] lg:flex hidden" alt=""/>
                        <div className="flex md:items-center items-start mt-10">
                            <div className="sm:w-[80px] w-[50px] sm:h-[80px] h-[50px] border-2 border-[#D8FB50] rounded-full flex flex-col items-center justify-center sm:text-[18px] text-[12px] sm:font-black font-normal">
                                <h1>Q2,</h1>
                    ...
                    <div className="flex items-center lg:ml-[34.5%] ml-[0%]">
                        <img src={Arrow} className="mt-[-5%] w-[80px] h-[120px] lg:flex hidden" alt=""/>
                        <div className="flex md:items-center items-start mt-10">
                            <div className="sm:w-[80px] w-[50px] sm:h-[80px] h-[50px] border-2 border-[#D8FB50] rounded-full flex flex-col items-center justify-center sm:text-[18px] text-[12px] sm:font-black font-normal">
                                <h1>Q2,</h1>
                    ...
                    <div className="flex items-center lg:ml-[44%] ml-[0%]">
                        <img src={Arrow} className="mt-[-5%] w-[80px] h-[120px] lg:flex hidden" alt=""/>
                        <div className="flex md:items-center items-start mt-10">
                            <div className="sm:w-[80px] w-[50px] sm:h-[80px] h-[50px] border-2 border-[#D8FB50] rounded-full flex flex-col items-center justify-center sm:text-[18px] text-[12px] sm:font-black font-normal">
                                <h1>Q2,</h1>
