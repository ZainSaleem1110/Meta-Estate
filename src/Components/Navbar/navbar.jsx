      ...
      {check === 0 && (
        <div className="w-[100%] flex justify-center relative p-0 m-0">
          ...
          <div className="w-full bg-black sm:rounded-b-full rounded-none md:h-[800px] sm:h-[700px] h-[600px] flex flex-col items-center">
            <img src={HouseModel} className="absolute lg:top-[58%] md:top-[65%] sm:top-[70%] top-[75%] lg:w-[45%] sm:w-[55%] w-[70%]" alt="housemodel" />
      ...
      {check === 1 && (
        <div className='absolute w-[100%] z-50 top-0 left-0 overflow-hidden bg-dark' style={{ height: "100vh" }}>
          ...
          <ul className="mt-4 px-5 list1">
            ...
            <li className="border-b border-gray-400 pb-3 mt-3">
              <div className="flex">

                <div className="text-black w-8 h-8 rounded-full bg-white flex items-center justify-center"><a href="#insta"><FaInstagram className="text-xl text-black" /></a></div>

                <div className="ml-4 text-black w-8 h-8 rounded-full bg-white flex items-center justify-center"><a href="#twitter"><FaTwitter className="text-xl text-black" /></a></div>
